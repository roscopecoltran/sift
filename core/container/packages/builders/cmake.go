...
func (cmake CMake) Build(config sift.Config) error {

	bootstrap := sift.ConfigureCmd{
...
func (cmake CMake) Install(config sift.Config) error {
...
func (cmake CMake) Dependencies() []sift.Package {
	return []sift.Package{}
}
