...
func (llvm LLVM) Build(config sift.Config) error {
...
func downloadArchiveTo(archive gogurt.SourceArchive, dst string, config sift.Config) error {
...
func (llvm LLVM) Install(config sift.Config) error {
...
func (llvm LLVM) Dependencies() []sift.Package {
	return []sift.Package{
		CMake{},
		// Ncurses{},
	}
