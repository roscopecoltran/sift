...
func (python3 Python3) Name() string {
	return "python3"
}

func (python3 Python3) URL(version string) string {
	return fmt.Sprintf("https://www.python.org/ftp/python/%s/Python-%s.tar.xz", version, version)
}

func (python3 Python3) Build(config sift.Config) error {
	...
	configure := sift.ConfigureCmd{
		Prefix: config.InstallDir(python3),
		Args: []string{
			"--disable-shared",
			"--enable-unicode=ucs4",
			"--with-system-expat",
...
func (python3 Python3) Install(config sift.Config) error {
...
func (python3 Python3) Dependencies() []sift.Package {
	return []sift.Package{
		Expat{},
		LibFFI{},
		Ncurses{},
