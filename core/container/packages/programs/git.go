...
func (git Git) Build(config sift.Config) error {

	makeConfigure := sift.MakeCmd{Args: []string{"configure"}}.Cmd()
...
func (git Git) Install(config sift.Config) error {
	makeInstall := sift.MakeCmd{Args: []string{"install"}}.Cmd()
	return makeInstall.Run()
}

func (git Git) Dependencies() []sift.Package {
	return []sift.Package{
		Curl{},
		OpenSSL{},
		Pcre{},
