...
func (python2 Python2) Build(config sift.Config) error {
...
func (python2 Python2) Install(config sift.Config) error {
...
func (python2 Python2) Dependencies() []sift.Package {
	return []sift.Package{
		Expat{},
		LibFFI{},
		Ncurses{},
