...
func (ncurses Ncurses) Build(config sift.Config) error {
...
func (ncurses Ncurses) Install(config sift.Config) error {
	make := sift.MakeCmd{Args: []string{"install"}}.Cmd()
...
func (ncurses Ncurses) Dependencies() []sift.Package {
	return []sift.Package{}
}
...
func getTerminals(config sift.Config) ([]string, error) {
	ncurses := Ncurses{}
